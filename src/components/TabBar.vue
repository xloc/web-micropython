<template>
  <div class="flex items-center justify-between bg-gray-100 border-b px-4 py-2 h-12">
    ...
    <div class="flex items-center space-x-4">
      <div class="flex items-center bg-white rounded px-3 py-1 border">
        ...
        <span 
          ...
          class="ml-1 w-2 h-2 bg-orange-400 rounded-full"
    ...
    <div class="flex items-center space-x-2">
      ...
      <div 
        class="flex items-center space-x-2 px-3 py-1 rounded text-sm"
        :class="connectionStatusClass"
      >
        <div 
          class="w-2 h-2 rounded-full"
          :class="serialStore.isConnected ? 'bg-green-400' : 'bg-red-400'"
        />
      ...
      >
        <component 
          :is="uiStore.splitOrientation === 'vertical' ? ViewColumnsIcon : Bars3Icon"
          class="w-4 h-4"
        />
      </button>
    </div>
